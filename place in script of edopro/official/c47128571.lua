...
function s.filter(c,tp)
	return c:IsMonster() and c:IsLocation(LOCATION_REST) and Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsAttackBelow,c:GetDefense()),tp,0,LOCATION_MZONE,1,nil)
end
