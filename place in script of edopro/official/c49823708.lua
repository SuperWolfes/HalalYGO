...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>0 and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_REST+LOCATION_HAND,0,1,nil,e,tp) end
...
function s.costfilter(c)
	return c:IsSetCard(0xd6) and c:IsAbleToRestAsCost()
end
