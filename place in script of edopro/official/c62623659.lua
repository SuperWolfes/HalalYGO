...
function s.thfilter(c)
	return c:IsAbleToHand() and ((c:IsMonster() and (c:IsSetCard(0x107e) or c:IsSetCard(0x207e))) or (c:IsActional() and (c:IsSetCard(0x7e) or c:IsSetCard(0x95) or c:IsSetCard(0x15d))) or c:IsTrap() and c:IsSetCard(0x7e))
end
