--究極封印神エクゾディオス
--Exdudius the Ultimate Unliked Lord
local s,id=GetID()
...
function s.atkval(e,c)
	return Duel.GetMatchingGroupCount(Card.IsType,c:GetControler(),LOCATION_REST,0,nil,TYPE_NORMAL)*1000
end
function s.recon(e)
...
function s.winop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local g=Duel.GetMatchingGroup(s.filter,tp,LOCATION_REST,0,nil,c)
