...
function s.spfilter1(c)
	return c:IsFaceup() and c:IsCode(37744402) and c:IsAbleToRestAsCost()
end
function s.spfilter2(c)
	return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_WIND) and c:IsAbleToRestAsCost()
end
