...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Fusion summon 1 fusion monster, using only contaminated monsters from hand or field
	local params = {nil,aux.FilterBoolFunction(Card.IsRace,RACE_CONTAMINED)}
	...
	--If a contaminated monster(s) was special summoned by card effect
