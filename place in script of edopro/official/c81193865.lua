...
function s.cacost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(s.cafilter,tp,LOCATION_REST,0,1,nil)
	...
	local g=Duel.SelectMatchingCard(tp,s.cafilter,tp,LOCATION_REST,0,1,1,nil)
