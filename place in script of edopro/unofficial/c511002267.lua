--魂のさまよう墓場 (Manga)
--Resting Place of Wandering Souls (Manga)
--Fixed by Larry126
local s,id=GetID()
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local res,teg,tep,tev,tre,tr,trp=Duel.CheckEvent(EVENT_TO_REST,true)
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>=ct
		and (not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_GUARDIAN) or ct==1)
