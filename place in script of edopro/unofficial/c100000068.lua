...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	local g1=Duel.GetMatchingGroup(s.costfilter,tp,LOCATION_MZONE+LOCATION_REST,0,nil,100000055)
	local g2=Duel.GetMatchingGroup(s.costfilter,tp,LOCATION_MZONE+LOCATION_REST,0,nil,100000066)
	local g3=Duel.GetMatchingGroup(s.costfilter,tp,LOCATION_MZONE+LOCATION_REST,0,nil,100000067)
	local g=g1:Clone()
	g:Merge(g2)
	g:Merge(g3)
