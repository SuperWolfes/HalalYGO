...
function s.checkop(e,tp,eg,ep,ev,re,r,rp)
	if re and re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:IsActiveType(TYPE_ACTIONAL) and re:GetHandler():IsSetCard(0x95) then
		s[0]=s[0]+1
	end
end
...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return re and eg:IsExists(s.cfilter,1,nil,tp) and re:GetHandler():IsActional() and re:GetHandler():IsSetCard(0x95)
end
