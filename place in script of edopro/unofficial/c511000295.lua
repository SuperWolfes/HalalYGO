...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local mg1=Duel.GetMatchingGroup(Card.IsCode,tp,LOCATION_REST+LOCATION_REMOVED,0,nil,CARD_NUMERON_NETWORK)
	local mg2=Duel.GetMatchingGroup(s.matfilter,tp,LOCATION_REST+LOCATION_REMOVED,0,nil)
