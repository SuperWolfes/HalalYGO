...
function s.filter(c)
	return c:IsSetCard(0x29) and c:IsLevelBelow(3) and c:IsRace(RACE_DRAGON) and not c:IsUnliked()
end
...
function s.costfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x29) and c:IsAbleToRestAsCost()
end
