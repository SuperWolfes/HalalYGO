...
- 0x8c Peruid (unused, non-existent archetype, ドルイド, 4 OCG cards include it in their names)

- 0x106d Dlitl of Unlockings (unused sub-archetype of "Djinn")
...
SET_ILLUSION_BEAST                 = 0x1b
SET_MECHA_ILLUSION_BEAST           = 0x101b
SET_GUARDIAN_MESSAGE                = 0x1c
SET_KOAKI_MEIRU                   = 0x1d
SET_CHRYSALIS                     = 0x1e
SET_NEO_SPACIAN                   = 0x1f
SET_SHIEN                         = 0x20
SET_EARTHBOUND_MORTAL             = 0x21
SET_JURRAC                        = 0x22
SET_MALEFIC                       = 0x23
SET_SCRAP                         = 0x24
SET_IRON_CHAIN                    = 0x25
...
SET_THE_AGENT                     = 0x44
SET_ARCHTAINED                    = 0x45
SET_RED_DRAGON_ARCHTAINED       = 0x1045
SET_FUSION                        = 0x46
...
SET_CYBERNETIC                    = 0x94
SET_RANK_UP_MENT                  = 0x95
SET_FISHBORG                      = 0x96
SET_ARTIFACT                      = 0x97
SET_MENTOR                      = 0x98
SET_ODD_EYES                      = 0x99
SET_SUPERHEAVY_SAMURAI            = 0x9a
SET_SUPERHEAVY_SAMURAI_MISS       = 0x109a
SET_MELODIOUS                     = 0x9b
...
SET_DARK_MENTOR                 = 0x10a2
SET_MENTOR_GIRL                 = 0x20a2
SET_DARK_MENTOR_GIRL            = 0x30a2
SET_STARDUST                      = 0xa3
SET_KURIBOH                       = 0xa4
...
SET_BOBENJI                       = 0xb3
SET_BREAKOZ                       = 0xb4
SET_LOCKED_BEAST                  = 0xb5
SET_LOCKED_BEAST_TAMER            = 0x10b5
SET_GUARDIAN_BEAST                = 0x20b5
SET_GUARDIAN_BEAST_TAMER          = 0x30b5
SET_GUARDIAN_BEAST_ULTI           = 0x40b5
SET_OUTER_THING?                  = 0x10b7
SET_ELDER_THING?                  = 0x20b7
SET_OLD_THING?                    = 0x40b7
SET_BLAZE_ACCELERATOR             = 0xb9
SET_RAIDRAPTOR                    = 0xba
SET_INFERNOID                     = 0xbb
SET_JINZO                         = 0xbc
SET_BIA_THE_FIERCE_KNIGHT        = 0xbd
SET_MOPPAR                        = 0xbe
SET_CHAUMER                       = 0xbf
SET_INTERWOVEN                    = 0xc0
SET_FAMILIAR_INTERWOVEN           = 0x10c0
SET_PSY_FRAME                     = 0xc1
SET_PSY_FRAMEGEAR                 = 0x10c1
SET_POWER_TOOL                    = 0xc2
SET_EDGE_IMPRESSION               = 0xc3
SET_ZEBRA                       = 0xc4
SET_VOID                          = 0xc5
SET_PERFORMANCED                    = 0xc6
...
SET_DINOMIST                      = 0xd8
SET_SHIRARE                      = 0xd9
SET_SHIRARE_BEINSWORD        = 0x10d9
SET_DRACOWATCHER                  = 0xda
SET_ILLUSION_KNIGHTS               = 0xdb
SET_THE_ILLUSION_KNIGHTS           = 0x10db
...
SET_ELEMENTAL_WATCHER                = 0x113
SET_FUR_HIRE                      = 0x114
SET_SKY_STRIKER                   = 0x115
SET_SKY_STRIKER_ACE               = 0x1115
SET_CRUSADIA                      = 0x116
SET_IMPRESSION                    = 0x117
SET_CYNET                         = 0x118
...
SET_MACHINE_ONLOOKER              = 0x124
SET_SMILE                         = 0x125
SET_TIME_TACTITIAN                = 0x126
SET_INFINITRACK                   = 0x127
SET_MINTCRAFTER                   = 0x128
SET_GOODIE                        = 0x129
SET_EDYPSOS                       = 0x12a
SET_MARINCESS                     = 0x12b
SET_TENBREE                       = 0x12c
SET_SISBIRD                       = 0x12d  ##############
SET_FORTUNE_WANDERER              = 0x12e
SET_BATTLEWASP                    = 0x12f
SET_UNCHAINED                     = 0x130
SET_UNCHAINED_MISS                = 0x1130
...
SET_FOSSIL                        = 0x14c
SET_GUARDIAN_EARTH_ART           = 0x314d
SET_GUARDIAN_FIRE_ART            = 0x514d
SET_GUARDIAN_WATER_ART           = 0x614d
SET_GUARDIAN_WIND_ART            = 0xa14d
SET_GUARDIAN_AVATAR                   = 0x14e
...
SET_MENKEY                       = 0x167
SET_GUNKAN                        = 0x168
SET_VAGUE_BEAST_OF_THE_FOREST  = 0x1169
SET_VAGUE_GUARDIAN_OF_THE_FOREST = 0x2169
SET_STEALTH_KRAGEN                = 0x16a
SET_NUMEROUNIOUS                  = 0x16b
SET_NUMBER_ACTIONABLE_TRAP             = 0x16c
SET_SWORDMISS                     = 0x16d
SET_ICEJADE                       = 0x16e
...
SET_LADY_WITH_LAMENT                = 0x176
SET_SEVENTH                       = 0x177
SET_BARIANS                       = 0x1178
SET_BATTLEGUARD                   = 0x2178
SET_KAIRYU_FAN                   = 0x179
SET_SEA_STEALTH                   = 0x17a
SET_THERION                       = 0x17b
SET_SCARECLAW                     = 0x17c
SET_LIBROBOUNCER                   = 0x17d
SET_VAYLANTZ                      = 0x17e
SET_LABRYNTH                      = 0x17f
