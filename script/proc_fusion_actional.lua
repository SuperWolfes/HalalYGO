--The function generates a default Fusion Summon effect. By default it's usable for Actionals/Traps, usage in monsters requires changing type and code afterwards.
				...
				if #sg1>0 then
					...
					if sel[1]==e then
						...
						if #mat1>0 then
							...
							--to the RP, and execute the operation of the
							--EFFECT_EXTRA_FUSION_MATERIAL effect, if it exists.
							--If it doesn't exist then send the extra materials to the RP.
