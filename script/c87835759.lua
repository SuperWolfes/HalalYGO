...
function s.tgfilter(c)
	local lv=c:GetLevel()
	return c:IsRace(RACE_DRAGON) and (lv==7 or lv==8) and c:IsAbleToRest()
end
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1 and e:GetHandler():IsAbleToRest()
