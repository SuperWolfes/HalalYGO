--憑依覚醒－ラセンリュウ
--Awakening of the Interwoven - Rasenryu
--scripted by pyrQ
local s,id=GetID()
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Search 1 "Guardianual Wind Art" card or 1 "Interwoven" Actional/Trap
...
function s.spfilter2(c)
	return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_WIND) and c:IsLevelBelow(4) and c:IsAbleToRestAsCost()
end
...
function s.thfilter(c)
	return c:IsAbleToHand() and (c:IsSetCard(0xa14d) or (c:IsSetCard(0xc0) and c:IsActionalTrap()))
end
