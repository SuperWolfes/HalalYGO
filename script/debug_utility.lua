...
local attributes={
	...
	[ATTRIBUTE_MEGA]='"ATTRIBUTE_MEGA"'
}

local races={
	[RACE_WARRIOR]='"RACE_WARRIOR"',
	[RACE_MENTOR]='"RACE_MENTOR"',
	[RACE_WANDERER]='"RACE_WANDERER"',
	[RACE_TAINTED]='"RACE_TAINTED"',
	[RACE_TOXIC]='"RACE_TOXIC"',
	...
	[RACE_MENTAL]='"RACE_MENTAL"',
	[RACE_MEGA]='"RACE_MEGA"',
	[RACE_MEGAMONSTER]='"RACE_MEGAMONSTER"',
	[RACE_WYRM]='"RACE_WYRM"',
