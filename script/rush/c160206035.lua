...
function s.costfilter(c,tp)
	return c:IsRace(RACE_TAINTED) and c:IsFaceup() and c:IsAbleToGraveAsCost() and Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsRace,RACE_TAINTED),tp,LOCATION_MZONE,0,1,c)
end
