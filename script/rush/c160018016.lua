...
function s.spfilter(c,e,tp)
	return c:IsLevel(7) and c:IsRace(RACE_WARRIOR) and c:IsAttack(2500) and c:IsDefense(2000) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
