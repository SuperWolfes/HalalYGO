...
function s.cfilter(c,e,tp)
	return c:IsSummonPlayer(1-tp) and c:IsType(TYPE_EFFECT) and c:IsFaceup() and not c:IsMaximumModeSide()
		and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_REST,0,1,nil,e,tp,c:GetAttack())
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_REST,0,1,1,nil,e,tp,atk)
