...
function s.initial_effect(c)
	--Inflict 100 damage per actional
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Damage(p,d,REASON_EFFECT)>=1000 and Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_REST,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(id,1)) then
