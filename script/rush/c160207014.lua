--深淵竜神アビス・ポセイドラ
--Abyssal Dragon Watcher Abyss Poseidra
...
function s.indcon(e)
	return e:GetHandler():IsMaximumMode() and not Duel.IsExistingMatchingCard(Card.IsMonster,e:GetHandlerPlayer(),LOCATION_REST,0,1,nil)
end