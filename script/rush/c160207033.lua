...
function s.initial_effect(c)
	-- Mill 1 and add 1 Sea Serpent Maximum monster from the RP to the hand
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetOperatedGroup():FilterCount(Card.IsLocation,nil,LOCATION_REST)==0 then return end
