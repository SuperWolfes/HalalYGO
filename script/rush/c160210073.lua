--焔魔の永狼
--Eternal Wolf of the Blaze Tainteds
...
function s.tgfilter(c)
	return c:IsMonster() and c:IsRace(RACE_TAINTED) and c:IsAbleToRestAsCost()
end
...
function s.thfilter(c)
	return c:IsMonster() and c:IsRace(RACE_TAINTED) and c:IsLevel(4) and c:IsAttack(0) and c:IsAbleToHand()
end
