...
function s.cfilter(c)
	return c:IsCode(160010102,160010027,160010062) and c:IsAbleToRestAsCost()
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if #dg>0 then
		...
		if Duel.Destroy(dg,REASON_EFFECT)>0 then
			local g=Duel.GetMatchingGroup(Card.IsRace,tp,LOCATION_REST,0,nil,RACE_AQUA)
