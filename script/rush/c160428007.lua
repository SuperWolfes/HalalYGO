...
function s.initial_effect(c)
	--Send the top 4 cards from the Deck to the RP
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_TOREST,nil,4,tp,LOCATION_DECK)
end
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	--Effect
	Duel.DiscardDeck(tp,4,REASON_EFFECT)
	--Prevent non-DARK Mentor from attacking
...
function s.atktg(e,c)
	return not (c:IsRace(RACE_MENTOR) and c:IsAttribute(ATTRIBUTE_DARK))
end
