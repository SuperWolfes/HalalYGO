...
function s.atkfilter(c)
	return (c:IsLevel(7) or c:IsLevel(8) or c:IsLevel(9)) and (c:IsRace(RACE_TAINTED) or c:IsRace(RACE_BEASTWARRIOR) or c:IsRace(RACE_MACHINE)) and c:IsFaceup()
end
function s.atkfilter2(c)
	return (c:IsRace(RACE_WANDERER) or c:IsRace(RACE_DRAGON) or c:IsRace(RACE_MENTOR)) and c:IsFaceup()
end
