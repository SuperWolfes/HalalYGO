...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local ct=Duel.GetMatchingGroupCount(Card.IsSpellTrap,tp,0,LOCATION_REST,nil)
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.HintSelection(g,true)
	local ct=Duel.GetMatchingGroupCount(Card.IsSpellTrap,c:GetControler(),0,LOCATION_REST,nil)
	local e1=Effect.CreateEffect(c)
	...
	if Duel.GetMatchingGroupCount(Card.IsSpell,c:GetControler(),0,LOCATION_REST,nil)>4
