...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc then
		...
		if tc:IsCode(160014008) and Duel.IsExistingMatchingCard(aux.RestValleyFilter(s.thfilter),tp,LOCATION_REST,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(id,2)) then
