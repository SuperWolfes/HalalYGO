...
function s.filter(c,e,sp)
	return c:IsLevelBelow(8) and c:IsRace(RACE_WARRIOR+RACE_WANDERER) and c:IsCanBeSpecialSummoned(e,0,sp,false,false)
end
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ct>0 and Duel.IsExistingMatchingCard(s.tdfilter,tp,0,LOCATION_REST,1,nil) end
