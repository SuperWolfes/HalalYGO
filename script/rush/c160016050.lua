...
function s.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_DRAW|CATEGORY_SUFFICE)
...
function s.costfilter(c)
	return c.roll_dice and c:IsAbleToRestAsCost()
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Draw(tp,d,REASON_EFFECT)>0 and d<=3 and Duel.IsExistingMatchingCard(aux.NecroValleyFilter(s.thfilter),tp,LOCATION_REST,0,1,nil)
