...
function s.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_DESTROY|CATEGORY_SPECIAL_SUMMON|CATEGORY_SUFFICE)
...
function s.matfilter(c)
	return c:IsLocation(LOCATION_MZONE) and c:IsRace(RACE_WANDERER) and c:IsAbleToGrave()
end
