...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,Card.IsAbleToRestAsCost,tp,LOCATION_ONFIELD|LOCATION_HAND,0,1,1,c):GetFirst()
	if Duel.SendtoRest(tc,REASON_COST)==0 then return end
	--Effect
	local e1=Effect.CreateEffect(c)
