...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectUnselectGroup(Duel.GetMatchingGroup(aux.GraveValleyFilter(s.eqfilter),tp,LOCATION_REST,0,nil),e,tp,1,math.min(ft,3),s.eqcon,1,tp,HINTMSG_EQUIP)
