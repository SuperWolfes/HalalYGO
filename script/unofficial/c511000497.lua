...
function s.initial_effect(c)
	--Fusion material
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,CARD_NEOS,aux.FilterBoolFunctionEx(Card.IsSetCard,SET_YUBEL))
...
s.material_setcode={SET_HERO,SET_ELEMENTAL_HERO,SET_NEOS,SET_YUBEL}
