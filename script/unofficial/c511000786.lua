...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(s.cfilter1,tp,LOCATION_REST,0,1,nil,e,tp,eg,ep,ev,re,r,rp,chain) 
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsExistingMatchingCard(s.cfilter1,tp,LOCATION_REST,0,1,nil,e,tp,eg,ep,ev,re,r,rp,chain) then return end
	local g=Duel.SelectMatchingCard(tp,s.filter,tp,LOCATION_REST,0,1,1,nil,e,tp,eg,ep,ev,re,r,rp,chain)
	if #g>0 then
		local tc=g:GetFirst()
