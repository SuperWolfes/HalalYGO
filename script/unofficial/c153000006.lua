...
function s.val(e,c)
	return Duel.GetMatchingGroupCount(Card.IsCode,c:GetControler(),LOCATION_REST,LOCATION_REST,nil,30208479,CARD_DARK_MAGICIAN)*300
end
...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Draw(tp,Duel.GetMatchingGroupCount(Card.IsMonster,tp,LOCATION_REST,0,nil),REASON_EFFECT)
end