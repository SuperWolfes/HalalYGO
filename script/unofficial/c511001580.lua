...
function s.tgfilter(c)
	return c:IsType(TYPE_PENDULUM) and c:IsAbleToRest()
end
...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return a:IsControler(1-tp) and (a:GetSummonType()&SUMMON_TYPE_SPECIAL)==SUMMON_TYPE_SPECIAL 
