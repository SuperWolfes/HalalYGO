...
s.listed_series={SET_MEKWATCHER_EMPEROR}
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsSetCard,SET_MEKWATCHER_EMPEROR),tp,LOCATION_MZONE,0,1,nil)
end
