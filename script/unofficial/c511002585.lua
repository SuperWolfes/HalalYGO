...
function s.initial_effect(c)
	--Special Summon monsters you control destroyed by battle from the RPs
...
function s.chkfilter(c,e,tp)
	return c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:IsLocation(LOCATION_REST)
end
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(s.cfilter,tp,LOCATION_REST,LOCATION_REST,nil,tp,Duel.GetTurnCount())
