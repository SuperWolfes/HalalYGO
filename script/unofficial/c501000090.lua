--
--Masterful Mentor, Servant of the Sanctuary
local s,id=GetID()
function s.initial_effect(c)
	...
	--Can only Tribute Mentor monsters for its Normal Summon
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_SINGLE)
	e1:SetCode(EFFECT_TRIBUTE_LIMIT)
	e1:SetValue(function(_e,_c) return not _c:IsRace(RACE_MENTOR) end)
	c:RegisterEffect(e1)
	--Win the Match
