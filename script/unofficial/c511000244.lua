--究極封印解放儀式術
--Ultimate Locked of the Forbidden Watcher
local s,id=GetID()
function s.initial_effect(c)
	...
	e1:SetProperty(0,EFFECT_FLAG2_FCOREE_ACTIVATE_LOCATION)
...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(Card.IsSetCard,tp,LOCATION_HAND+LOCATION_REST,0,nil,0x40)
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_TODECK,rg,#rg,tp,LOCATION_REST)
	Duel.SetOperationInfo(0,CATEGORY_TOREST,nil,2,tp,LOCATION_HAND)
