...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Destroy(dg,REASON_EFFECT)>0 or #dg==0 then
		...
		local g=Duel.GetMatchingGroup(aux.GraveValleyFilter(s.spfilter),tp,LOCATION_EXTRA+LOCATION_REST,0,nil,e,tp)
		...
		local og=Duel.GetMatchingGroup(aux.GraveValleyFilter(Card.IsCode),tp,LOCATION_EXTRA+LOCATION_REST,0,nil,69610326)
