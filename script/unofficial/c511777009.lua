...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,CARD_DARK_MENTOR_GIRL),tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	--Send this card to Resting Place during End Phase
	aux.DelayedOperation(c,PHASE_END,id,e,tp,function(ag) Duel.SendtoRest(ag,REASON_EFFECT) end,nil,0)
end
