...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Inflict damage to the player with the lowest total monster Levels
...
function s.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if lv1>lv2 then
		Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,1-tp,(lv1-lv2)*100)
	end
	if lv2<lv1 then
		Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,tp,(lv2-lv1)*100)
	end
end
