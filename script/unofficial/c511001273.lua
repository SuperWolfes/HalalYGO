...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_REST,0,ft,ft,nil,e,tp,Duel.GetTurnCount())
	if #g>0 then
...
function s.numsptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,aux.GraveValleyFilter(s.numspfilter),tp,LOCATION_REST,0,1,1,nil,e,tp)
