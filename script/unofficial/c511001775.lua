...
function s.filter(c,e,tp)
	return c:IsFaceup() and c:GetLevel()>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,id,0,0x1,c:GetAttack(),c:GetDefense(),c:GetLevel(),c:GetRace(),c:GetAttribute())
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	c:AddMonsterAttribute(TYPE_MONSTER+TYPE_ACTIONAL+TYPE_TRAP)
