...
function s.erasop(e,tp,eg,ep,ev,re,r,rp)
	...
	local mega_evo_label=e:GetLabel()
	if mega_evo_label==0 then
		Duel.SendtoGrave(g,REASON_EFFECT)
	elseif mega_evo_label==1 then
...
function s.divevo(e,tp,eg,ev,ep,re,r,rp)
	local mega_hierarchy=e:GetHandler():GetFlagEffectLabel(513000065)
	if mega_hierarchy>1 then
