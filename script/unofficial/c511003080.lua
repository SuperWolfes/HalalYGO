...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,42671152,0,TYPES_TOKEN,-2,-2,1,RACE_TAINTED,ATTRIBUTE_DARK) end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if rec~=s[tp] or Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,42671152,0,TYPES_TOKEN,-2,-2,1,RACE_TAINTED,ATTRIBUTE_DARK) then return end
