...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Substitute mismatching for a level 3 or lower toxic monster(s)
...
s.listed_names={CARD_SKULL_SERVANT,id}
	...
	--Check for level 3 or lower toxic monsters
function s.repfilter(c,tp)
	return c:IsFaceup() and c:IsRace(RACE_TOXIC) and c:IsLevelBelow(3) and c:IsControler(tp)
...
function s.repval(e,c)
	...
	--Discard itself as substitute for a level 3 or lower toxic monster's mismatching
