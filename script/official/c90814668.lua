...
function s.costfilter(c,e,tp)
	return c:IsType(TYPE_EFFECT) and (Duel.GetLocationCount(tp,LOCATION_MZONE)>0 or c:IsInMainMZone()) and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_REST,0,1,nil,e,tp,c)
end
