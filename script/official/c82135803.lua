...
s.listed_names={60764609} --"The Taintedsmith"
...
function s.tgcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.IsExistingMatchingCard(s.tgcostfilter,tp,LOCATION_REST,0,1,c) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(tp,s.tgcostfilter,tp,LOCATION_REST,0,1,1,c)
	Duel.HintSelection(g)
