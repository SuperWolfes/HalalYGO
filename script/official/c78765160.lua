...
function s.cfilter(c)
	return c:IsFaceup() and c:IsRace(RACE_CONTAMINED) and c:IsAbleToRemoveAsCost()
end
...
function s.tdfilter(c)
	return c:IsFaceup() and c:IsRace(RACE_CONTAMINED) and c:IsDefenseBelow(0) and c:IsAbleToDeck()
end
