...
function s.initial_effect(c)
	...
	e1:SetValue(1)
	c:RegisterEffect(e1)
	--Special Summon 1 "Gimmick Puppet Nightmare" from your hand or RP
...
function s.hgysptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(s.hgyspfilter,tp,LOCATION_HAND|LOCATION_REST,0,1,nil,e,tp) end
