...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Search 1 "Flybie's Feather Duster"
...
function s.handcon(e)
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsSetCard,SET_FLYBIE),e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
end
