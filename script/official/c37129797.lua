...
function s.initial_effect(c)
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsRace,RACE_CONTAMINED))
...
function s.drfilter(c)
	return ((c:IsLocation(LOCATION_MZONE) and c:IsRace(RACE_CONTAMINED)) 
		or (not c:IsLocation(LOCATION_MZONE) and c:GetPreviousRaceOnField()==RACE_CONTAMINED)) 
