...
function s.spfilter1(c,tp)
	return c:IsFaceup() and c:IsCode(37970940) and c:IsAbleToRestAsCost()
end
function s.spfilter2(c)
	return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_EARTH) and c:IsAbleToRestAsCost()
end
