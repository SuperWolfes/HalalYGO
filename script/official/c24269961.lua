...
function s.initial_effect(c)
	...
	--Add 1 "Unchained" monster from the Deck or RP to the hand
	...
	c:RegisterEffect(e1)
	--Special Summon 1 Tainted monster from the hand or RP and destroy 1 card on the field
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_REST|LOCATION_HAND,0,1,e:GetHandler(),e,tp) end
