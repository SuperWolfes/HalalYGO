...
function s.initial_effect(c)
	...
	--Fusion Summon 1 Tainted Fusion Monster by shuffling its materials from your RP into the Deck
	local params={fusfilter=aux.FilterBoolFunction(Card.IsRace,RACE_TAINTED),
					matfilter=aux.FALSE,
					extrafil=s.fextra,
					extratg=s.extratg,
