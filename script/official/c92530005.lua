...
function s.tgfilter(c)
	return c:IsSetCard(SET_PERFORMANCED) and c:IsType(TYPE_PENDULUM) and c:IsFaceup() and c:IsAbleToRest()
end
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SendtoRest(tc,REASON_EFFECT)>0 and tc:IsLocation(LOCATION_REST) and tc:GetLeftScale()>0
