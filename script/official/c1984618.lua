...
function s.tgfilter(c,tp,rest)
	return c:IsAbleToRest() and Duel.IsExistingMatchingCard(rest and aux.NecroValleyFilter(s.thfilter) or s.thfilter,tp,LOCATION_DECK+LOCATION_REST,0,1,nil,c:GetAttack())
end
