...
function s.tgfilter(c,tp,rest)
	return c:IsAbleToGrave() and Duel.IsExistingMatchingCard(rest and aux.RestValleyFilter(s.thfilter) or s.thfilter,tp,LOCATION_DECK+LOCATION_REST,0,1,nil,c:GetAttack())
end
