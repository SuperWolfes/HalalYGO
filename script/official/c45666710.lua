...
function s.initial_effect(c)
	--Special summon 1 of your "Nemeses" monsters, that is banished or in RP
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,g,1,0,LOCATION_REST+LOCATION_REMOVED)
end
