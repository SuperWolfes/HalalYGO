...
function s.initial_effect(c)
	...
	--Search 1 "Superheavy Samurai Miss"
	...
	c:RegisterEffect(e1)
	--Send 1 "Superheavy Samurai Big Benkei" to the RP
...
s.listed_series={SET_SUPERHEAVY_SAMURAI,SET_SUPERHEAVY_SAMURAI_MISS}
...
function s.thfilter(c)
	return c:IsSetCard(SET_SUPERHEAVY_SAMURAI_MISS) and c:IsMonster() and c:IsAbleToHand()
end
...
function s.tgfilter(c)
	return c:IsCode(3117804) and c:IsAbleToRest()
end
