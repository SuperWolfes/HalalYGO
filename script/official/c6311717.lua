...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Send to the resting place and special summon
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.SendtoGrave(tc,REASON_EFFECT)~=0 and tc:IsLocation(LOCATION_REST) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 then
