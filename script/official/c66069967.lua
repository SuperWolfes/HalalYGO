...
function s.initial_effect(c)
	--Special Summon itself if tributed and sent to the RP
	...
	c:RegisterEffect(e2)
	--Locked monsters you control cannot be targeted by opponent's effects
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsType,TYPE_LOCKED))
	e3:SetValue(aux.tgoval)
	c:RegisterEffect(e3)
	--Locked monsters you control cannot be destroyed by opponent's effects
	local e4=e3:Clone()
	e4:SetProperty(0)
