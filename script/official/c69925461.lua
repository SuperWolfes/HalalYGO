...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Special Summon 1 Level 6 or lower monster from your hand or RP
...
function s.lv6sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local locations=hasbox and LOCATION_HAND|LOCATION_REST or LOCATION_HAND
...
function s.lv6spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.RestValleyFilter(s.lv6spfilter),tp,locations,0,1,1,nil,e,tp)
	if #g>0 then
