...
function s.initial_effect(c)
	--Fusion Summon by using this card and opponent's monsters as material
	local params = {nil,Fusion.CheckWithHandler(aux.FALSE),s.fextra,nil,Fusion.FcoreedHandler}
