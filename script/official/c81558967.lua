...
function s.initial_effect(c)
	--Excavate cards from your Deck, up to the number of "Balkanie" monsters you control
	...
	c:RegisterEffect(e1)
	--Special Summon 1 "balkanie" monster from your Deck
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local ct=Duel.GetMatchingGroupCount(aux.FaceupFilter(Card.IsSetCard,SET_BALKANIE),tp,LOCATION_MZONE,0,e:GetHandler())
...
function s.spfilter1(c,e,tp)
	return c:IsSetCard(SET_BALKANIE) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
