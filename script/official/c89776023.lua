...
function s.initial_effect(c)
	--Special Summon 1 "Evoltile" monster from the hand or RP
	...
	c:RegisterEffect(e2)
	--Set 1 "Evo-Fcoree" or "Evo-Instant" from the Deck
...
s.listed_names={5338223,24362891} --Evo-Fcoree, Evo-Instant
