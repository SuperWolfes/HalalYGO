--刻まれし魔の神聖棺
--Taintedsmith's Agnusdei
--scripted by pyrQ
local s,id=GetID()
function s.initial_effect(c)
	c:EnableReviveLimit()
	--Link Summon procedure: 2+ monsters, including a LIGHT Tainted monster
	Link.AddProcedure(c,nil,2,3,s.lcheck)
	--Special Summon 1 LIGHT non-Link Tainted monster in your RP and equip it with this card
...
function s.spfilter(c,e,tp)
	return c:IsAttribute(ATTRIBUTE_LIGHT) and not c:IsLinkMonster() and c:IsRace(RACE_TAINTED)
