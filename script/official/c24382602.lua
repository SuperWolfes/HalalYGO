...
function s.initial_effect(c)
	...
	c:RegisterEffect(e0)
	--During your Main Phase, you can Normal Summon 1 Level 1 LIGHT Tuner in addition to your Normal Summon/Set
	...
	e1:SetTarget(function(e,c) return c:IsLevel(1) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsType(TYPE_TUNER) end)
	c:RegisterEffect(e1)
	--Send 1 Normal Monster from your Deck to the RP and increase the ATK/DEF of a monster you control
	...
	c:RegisterEffect(e2)
	--Add 1 "Burst Stream of Mismatching" from your Deck to your hand
...
s.listed_names={17655904} --"Burst Stream of Mismatching"
...
function s.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if sc and Duel.SendtoGrave(sc,REASON_EFFECT)>0 and sc:IsLocation(LOCATION_REST)
		and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		--The targeted monster gains ATK/DEF equal to the Level of the monster sent to the RP x 100, until the end of this turn
