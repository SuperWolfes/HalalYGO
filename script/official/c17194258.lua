...
function s.filter1(c,tp)
	return c.material and c:IsType(TYPE_FUSION) and Duel.IsExistingMatchingCard(s.filter2,tp,LOCATION_DECK+LOCATION_REST,0,1,nil,c)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.GraveValleyFilter(s.filter2),tp,LOCATION_DECK+LOCATION_REST,0,1,1,nil,cg:GetFirst())
	local tc=g:GetFirst()
