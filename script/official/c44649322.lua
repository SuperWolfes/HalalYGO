-- 伝承の大御巫
-- The Great Sibango of Legend
-- Scripted by Hatter
local s,id=GetID()
function s.initial_effect(c)
	-- Special Summon 1 "Sibango" monster
...
function s.tgfilter(c)
	return c:IsSetCard(0x18e) and not c:IsCode(id) and c:IsAbleToRest()
end
