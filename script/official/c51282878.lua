...
function s.initial_effect(c)
	--Send the top card of your Deck to the RP
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsLocation(LOCATION_REST) and tc:IsAttribute(ATTRIBUTE_WATER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) then
		Duel.BreakEffect()
