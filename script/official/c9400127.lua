...
function s.tgfilter(c,e,tp)
	return c:IsFaceup() and Duel.IsExistingTarget(s.spfilter,tp,0,LOCATION_REST,1,nil,e,tp,c:GetAttack())
end
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g2=Duel.SelectTarget(tp,s.spfilter,tp,0,LOCATION_REST,1,1,nil,e,tp,g1:GetFirst():GetAttack())
	Duel.SetOperationInfo(0,CATEGORY_TOREST,g1,1,tp,LOCATION_MZONE)
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,g2,1,0,LOCATION_REST)
end
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetTargetCards(e)
	local tc1=g:Filter(Card.IsLocation,nil,LOCATION_MZONE):GetFirst()
	local tc2=g:Filter(Card.IsLocation,nil,LOCATION_REST):GetFirst()
