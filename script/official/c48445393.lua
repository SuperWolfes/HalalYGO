...
function s.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_TOREST+CATEGORY_DRAW+CATEGORY_DESTROY)
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if gc and Duel.SendtoGrave(gc,REASON_EFFECT)>0 and gc:IsLocation(LOCATION_REST) and Duel.IsPlayerCanDraw(tp) then
		Duel.ShuffleDeck(tp)
		Duel.BreakEffect()
