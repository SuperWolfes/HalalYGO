...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local rt=Duel.GetTargetCount(Card.IsType,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil,TYPE_ACTIONAL+TYPE_TRAP)
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,Card.IsType,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,ct,ct,nil,TYPE_ACTIONAL+TYPE_TRAP)
