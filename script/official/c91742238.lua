--リターン・オブ・アンデット
--Return of the Toxics
--Scripted by Eerie Code

local s,id=GetID()
function s.initial_effect(c)
	--Banish 1 toxic monster from field, then controller of it special summons 1 toxic monster from their RP
...
function s.spfilter(c,e,tp,p)
	return c:IsRace(RACE_TOXIC) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE,p)
end
