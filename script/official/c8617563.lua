...
function s.initial_effect(c)
	...
	--Set 1 "Raidraptor" Actional/Trap directly from your Deck
	...
	--Search 1 "Rank-Up-Ment" Actional if it has a Winged Beast monster attached
...
function s.setfilter(c)
	return c:IsSetCard(SET_RAIDRAPTOR) and c:IsActionalTrap() and c:IsSSetable()
end
