...
function s.chainfilter(re,tp,cid)
	...
	return not (re:IsActiveType(TYPE_ACTIONAL+TYPE_TRAP) or not re:GetHandler():IsRace(RACE_DIVINE))
end
...
function s.aclimit(e,re,tp)
	return re:IsActiveType(TYPE_ACTIONAL+TYPE_TRAP) or not re:GetHandler():IsRace(RACE_DIVINE)
end
