...
function s.effop(e,tp,eg,ep,ev,re,r,rp)
	...
	local b1=Duel.IsExistingMatchingCard(aux.NecroValleyFilter(s.thfilter),tp,LOCATION_REST,0,1,nil)
	local b2=Duel.IsExistingMatchingCard(aux.NecroValleyFilter(s.tdfilter),tp,LOCATION_REST|LOCATION_REMOVED,0,1,nil)
