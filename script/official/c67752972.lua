...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Shuffle monsters from the RP and field into the Deck and Special Summon 1 "Watt" Synchro Monster from your Extra Deck
...
function s.rescon(sg,e,tp,mg)
	return sg:FilterCount(Card.IsLocation,nil,LOCATION_MZONE)==1
		and sg:FilterCount(Card.IsLocation,nil,LOCATION_REST)==1
...
function s.spsynctg(e,tp,eg,ep,ev,re,r,rp,chk)
	local g1=Duel.GetMatchingGroup(s.gyfilter,tp,LOCATION_REST,0,nil)
	...
	Duel.SetOperationInfo(0,CATEGORY_TODECK,nil,2,tp,LOCATION_MZONE|LOCATION_REST)
