--幻獣機コンコルーダ
--Mecha Illusion Beast Concoruda
local s,id=GetID()
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Special Summon 1 Level 4 or lower "Mecha Illusion Beast" monster from the Resting Place
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_MECHA_ILLUSION_BEAST) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
