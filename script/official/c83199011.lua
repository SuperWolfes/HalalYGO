...
function s.initial_effect(c)
	--Special Summon 1 "Springans" monster or "Fallen of Albaz" from your RP
...
function s.matfilter(c)
	return c:IsType(TYPE_FUSION) and c:ListsCodeAsMaterial(CARD_ALBAZ) and not c:IsUnliked()
end
