...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Give control of this card and Special Summon 1 "Sky Striker Ace" monster from your RP
...
function s.ctcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.ctcfilter,tp,LOCATION_REST,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,s.ctcfilter,tp,LOCATION_REST,0,1,1,nil)
