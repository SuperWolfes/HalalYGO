...
function s.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	local g=Duel.GetMatchingGroup(s.rmvfilter,tp,LOCATION_MZONE|LOCATION_REST,0,nil)
...
function s.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(s.rmvfilter,tp,LOCATION_MZONE|LOCATION_REST,0,tc)
	if #g>0 then
