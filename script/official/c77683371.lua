...
function s.drtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local ct=Duel.GetMatchingGroupCount(aux.FaceupFilter(Card.IsRace,RACE_MENTOR),tp,LOCATION_MZONE,0,nil)
...
function s.drop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local d=Duel.GetMatchingGroupCount(aux.FaceupFilter(Card.IsRace,RACE_MENTOR),tp,LOCATION_MZONE,0,nil)
