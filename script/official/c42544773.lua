...
function s.effop(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif op==2 then
		--Halve the ATK of 1 face-up monster your opponent controls until the end of this turn
...
function s.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	local ec=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.eqfilter),tp,LOCATION_EXTRA|LOCATION_REST,0,1,1,nil,tp):GetFirst()
