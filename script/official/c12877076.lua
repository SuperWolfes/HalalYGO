...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local b1=Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_DECK,0,1,nil)
	local b2=Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(aux.RestValleyFilter(s.spfilter),tp,LOCATION_HAND_DECK_REST_SZONE,0,1,nil,e,tp)
