...
function s.initial_effect(c)
	...
	e1:SetValue(1)
	c:RegisterEffect(e1)
	--Special Summon 1 Illusion from your RP
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Cannot Special Summon from the RP, except Illusion Monsters
	...
	e1:SetTarget(function(_,c) return not c:IsRace(RACE_ILLUSION) and c:IsLocation(LOCATION_REST) end)
