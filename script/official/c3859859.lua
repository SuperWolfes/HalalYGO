...
function s.initial_effect(c)
	...
	e1:SetCondition(function(e,tp) return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsContinuousActional),tp,LOCATION_ONFIELD,0,1,nil) end)
	e1:SetTarget(s.sptg)
	e1:SetOperation(s.spop)
	c:RegisterEffect(e1)
	--Send 1 Level 4 or lower LIGHT Mentor monster from your Deck to the RP
...
function s.tgfilter(c)
	return c:IsLevelBelow(4) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsRace(RACE_MENTOR) and c:IsAbleToGrave()
end
