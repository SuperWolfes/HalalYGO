...
function s.tgfilter(c)
	return c:IsRace(RACE_WARRIOR) and c:IsAbleToRest()
end
...
function s.atkval(e,c)
	return Duel.GetMatchingGroupCount(Card.IsRace,e:GetHandler():GetControler(),LOCATION_REST,0,nil,RACE_WARRIOR)*-100
end
