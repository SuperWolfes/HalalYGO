...
function s.arcanareg(c,coin)
	...
	e1:SetValue(function(_,c) return c:IsSetCard(SET_ARCANA_FCOREE) end)
...
function s.sumtg(e,c,tp,sumtp)
	return (sumtp&SUMMON_TYPE_TRIBUTE)==SUMMON_TYPE_TRIBUTE and c:IsSetCard(SET_ARCANA_FCOREE)
end