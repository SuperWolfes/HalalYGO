--ウィッチクラフト・コンフュージョン
--Mintcrafter Confusion
--Logical Nonsense

--Substitute ID
local s,id=GetID()
function s.initial_effect(c)
	--Fusion Summon 1 Fusion Monster, including 1+ "Mintcrafter" monster as material
...
function s.fextra(e,tp,mg)
	...
	--Check for face-up "Mintcrafter" monster and if it's your End Phase
