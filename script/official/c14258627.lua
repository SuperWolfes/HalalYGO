...
function s.spcon(e,c)
	...
	local rg=Duel.GetMatchingGroup(s.filter,tp,LOCATION_MZONE+LOCATION_REST,0,nil)
...
function s.mtop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_MZONE+LOCATION_REST,0,1,nil)
