...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Special Summon 1 "Mentoral Musketeer" monster from the RP
...
function s.filter(c,e,tp)
	return c:IsSetCard(SET_MENTORAL_MUSKET) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
