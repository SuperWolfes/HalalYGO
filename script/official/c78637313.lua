...
function s.initial_effect(c)
	...
	e3:SetTarget(function(_,c)return c:IsCode(CARD_MONSTER_REREST)end)
	c:RegisterEffect(e3)
	--Cannot activate "Monster Rerest"
	...
	e4:SetValue(function(_,re)return re:GetHandler():IsCode(CARD_MONSTER_REREST)end)
	c:RegisterEffect(e4)
end
