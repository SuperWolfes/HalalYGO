...
function s.initial_effect(c)
	--Special Summon 1 "Mimirahul" monster
	...
	c:RegisterEffect(e1)
	--Return any number of "Mimirahul" cards you control to the hand
...
function s.spfilter(c,e,tp,f1,f2)
	if not c:IsSetCard(SET_MIMIRAHUL) then return false end
...
function s.thfilter(c,e)
	return c:IsFaceup() and c:IsSetCard(SET_MIMIRAHUL) and c:IsAbleToHand() and c:IsCanBeEffectTarget(e)
end
