...
function s.initial_effect(c)
	...
	e1:SetCondition(function(e,tp) return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsLevel,10),tp,LOCATION_MZONE|LOCATION_REST|LOCATION_REMOVED,0,3,nil) end)
	e1:SetTarget(s.sptg)
