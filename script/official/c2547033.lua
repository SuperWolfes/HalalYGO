...
function s.tgfilter(c)
	return c:IsSetCard(SET_ALTERGEIST) and c:IsMonster() and c:IsAbleToRest()
end
...
function s.cfilter(c)
	return c:IsSetCard(SET_ALTERGEIST) and c:IsMonster() and c:IsAbleToRestAsCost()
end
