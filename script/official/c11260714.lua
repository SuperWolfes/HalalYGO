...
function s.filter(c,e,sp)
	return c:IsRace(RACE_WANDERER) and c:IsCanBeSpecialSummoned(e,0,sp,false,false) and not c:IsCode(id)
end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsRace(RACE_WANDERER) then
