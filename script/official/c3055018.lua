...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Place 1 "Obsidim, the Ashened City" from your RP on the bottom of your Deck, then draw 1 card
	...
	e3:SetCondition(function(e) return e:GetHandler():IsPreviousLocation(LOCATION_FZONE) end)
	e3:SetTarget(s.sptg)
