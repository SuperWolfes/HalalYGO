...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Search 1 "Melodious" Actional/Trap
	...
	c:RegisterEffect(e2)
	--Special Summon 1 Level 4 or lower "Melodious" monster from your hand or RP
...
function s.thfilter(c)
	return c:IsSetCard(SET_MELODIOUS) and c:IsActionalTrap() and c:IsAbleToHand()
end
