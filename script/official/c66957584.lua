...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,s.filter,tp,LOCATION_REST,0,1,ct,nil,e,tp)
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #sg==0 or ft<#sg or (#sg>1 and Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_GUARDIAN)) then return end
