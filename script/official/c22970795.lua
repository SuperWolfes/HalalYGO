...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Send cards from the top of the Deck to the RP, up to the number "Skull Servant"/"King of the Skull Servants" in the RP
	...
	c:RegisterEffect(e2)
	--Special summon 1 "Skull Servant" or "King of the Skull Servants" from your RP
...
function s.tgcond(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_REST,0,1,nil,CARD_SKULL_SERVANT,36021814)
end
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	local ct1=Duel.GetMatchingGroupCount(Card.IsCode,tp,LOCATION_REST,0,nil,CARD_SKULL_SERVANT,36021814)
