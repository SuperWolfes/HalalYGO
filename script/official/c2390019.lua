...
function s.ffilter(c,e,tp,rg,ft)
	...
	local g=Duel.GetMatchingGroup(s.spfilter,tp,LOCATION_HAND|LOCATION_DECK|LOCATION_REST,0,nil,e,tp,c.material)
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local sg=Duel.GetMatchingGroup(s.spfilter,tp,LOCATION_HAND|LOCATION_DECK|LOCATION_REST,0,nil,e,tp,rc.material)
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local mg=Duel.GetMatchingGroup(aux.NecroValleyFilter(s.spfilter),tp,LOCATION_HAND|LOCATION_REST|LOCATION_DECK,0,nil,e,tp,rc.material)
