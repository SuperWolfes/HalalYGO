...
function s.spfilter1(c)
	return c:IsFaceup() and c:IsCode(759393) and c:IsAbleToRestAsCost()
end
function s.spfilter2(c)
	return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_FIRE) and c:IsAbleToRestAsCost()
end
