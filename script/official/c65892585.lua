...
function s.thfilter(c)
	return c:IsSetCard(SET_GOLD_PRIDE) and c:IsActional() and c:IsAbleToHand()
end
...
function s.tgfilter(c)
	return c:IsMonster() and c:IsSetCard(SET_GOLD_PRIDE) and c:IsAbleToRest()
end
