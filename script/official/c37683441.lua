...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Special Summon 1 "Trickstar" monster from your RP
	...
	e2:SetCondition(function(e,tp) return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsType,TYPE_FUSION),tp,LOCATION_MZONE|LOCATION_REST,0,1,nil) end)
	e2:SetTarget(s.sptg)
...
s.listed_series={SET_TRICKSTAR,SET_BLUE_TEARS}
function s.thfilter(c)
	return c:IsSetCard(SET_BLUE_TEARS) and c:IsAbleToHand() 
end
