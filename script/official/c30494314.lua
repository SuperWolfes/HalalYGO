...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_REST) and re:GetHandler():IsRace(RACE_TOXIC)
end
function s.filter(c)
	return c:IsFaceup() and c:IsRace(RACE_TOXIC) and not c:IsType(TYPE_XYZ)
end
