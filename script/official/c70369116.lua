...
function s.copfilter(c)
	return c:IsAbleToGraveAsCost() and c:IsSetCard(0x46) and (c:GetType()==TYPE_ACTIONAL or c:GetType()==TYPE_ACTIONAL+TYPE_QUICKPLAY) and c:CheckActivateEffect(true,true,false)~=nil 
end
