...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Send 1 "Crystron" monster from your Deck to the Resting Place and change the Level of a targeted monster
...
function s.tgfilter(c,lv)
	return c:IsSetCard(SET_CRYSTRON) and c:GetLevel()~=lv and c:IsMonster() and c:IsAbleToRest()
end
