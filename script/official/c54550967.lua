...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	-- Special Summon 1 Level 2 or lower "Memento" monster from your RP
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return #dg>0 and Duel.IsExistingTarget(s.spfilter,tp,LOCATION_REST,0,1,nil,e,tp) end
