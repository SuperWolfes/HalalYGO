...
function s.eqfilter(c)
	return c:IsOriginalType(TYPE_MONSTER) and c:IsSetCard(0x152)
end
function s.spcond(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(s.eqfilter,1,nil)
end
function s.spfilter(c,e,tp)
	return c:IsRace(RACE_MENTOR) and c:IsLevel(4) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
