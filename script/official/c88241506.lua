...
function s.initial_effect(c)
	--Negate attack, change battle position and special summon 1 BEWD from hand, Deck or RP
	...
	c:RegisterEffect(e1)
	--Special Summon 1 BEWD from hand, Deck or RP
...
function s.natg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetPossibleOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_REST)
end
