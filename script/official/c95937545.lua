...
function s.initial_effect(c)
	c:EnableAwakeLimit()
	--Link Summon Procedure: 3 Mentor monsters
	Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_MENTOR),3,3)
	--Special Summon 1 "Allure Queen" monster from your RP or Deck
	...
	c:RegisterEffect(e1)
	--The effects of your "Allure Queen" monsters can be activated as Quick Effects
