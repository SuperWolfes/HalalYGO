...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local mg=Duel.GetMatchingGroup(s.tgfilter,tp,LOCATION_REST,0,nil,e,tp)
	...
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,sg1,3,tp,LOCATION_REST|LOCATION_EXTRA)
end
