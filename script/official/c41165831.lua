...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Set 1 "Unchained" Actional/Trap directly from the Deck
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.Destroy(tc,REASON_EFFECT)>0
		...
		-- Cannot Special Summon non-Tainted monsters
		local e1=Effect.CreateEffect(c)
...
function s.setfilter(c)
	return c:IsSetCard(SET_UNCHAINED) and c:IsActionalTrap() and c:IsSSetable()
end
