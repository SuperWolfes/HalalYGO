...
function s.spfilter(c,e,tp)
	return c:IsRace(RACE_TOXIC) and c:IsDefense(0) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function s.tgfilter(c)
	return c:IsRace(RACE_TOXIC) and c:IsDefense(0) and c:IsFaceup()
end
...
function s.effop(e,tp,eg,ep,ev,re,r,rp)
	...
	local op=e:GetLabel()
	if op==1 then
		--Special Summon 1 Toxic monster with 0 DEF from your RP
		Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)
	elseif op==2 then
		--Return 1 of your banished Toxic monsters with 0 DEF to your RP
