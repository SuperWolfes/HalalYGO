...
function s.filter(c,ft,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x111)
		and Duel.IsExistingMatchingCard(s.opfilter,tp,LOCATION_DECK+LOCATION_REST,0,1,nil,c:GetCode(),ft,e,tp)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local sc=Duel.SelectMatchingCard(tp,aux.GraveValleyFilter(s.opfilter),tp,LOCATION_DECK+LOCATION_REST,0,1,1,nil,tc:GetCode(),ft,e,tp):GetFirst()
