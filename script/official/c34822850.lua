...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,id+1,0xbb,TYPES_TOKEN,0,0,1,RACE_TAINTED,ATTRIBUTE_FIRE) end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	if not e:GetHandler():IsRelateToEffect(e)
		...
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,id+1,0xbb,TYPES_TOKEN,0,0,1,RACE_TAINTED,ATTRIBUTE_FIRE) then return end
