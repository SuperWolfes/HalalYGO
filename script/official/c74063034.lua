...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--shuffle itself into the Deck and return 1 "Aleister the Invalidater" to the hand
...
function s.checkmat(tp,sg,fc)
	return fc:IsSetCard(SET_INVALIDATED) or not sg:IsExists(Card.IsLocation,1,nil,LOCATION_REST|LOCATION_ONFIELD)
end
