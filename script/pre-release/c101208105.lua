...
function s.initial_effect(c)
	...
	--Add 1 Cyberse Locked Monster from your Deck to your hand
	...
	c:RegisterEffect(e1)
	--Locked Summon 1 Locked Monster from your hand, by Tributing monsters from your hand and/or field whose total Levels equal or exceed its Level
	local e2=Locked.CreateProc(c,RITPROC_GREATER,nil,nil,aux.Stringid(id,1))
...
function s.thfilter1(c)
	return c:IsRace(RACE_CYBERSE) and c:IsLockedMonster() and c:IsAbleToHand()
end
