...
s.listed_names={5405694,30208479} --Black Luster Soldier, Mentor of Black Chaos
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Mentor of Black Chaos cannot be destroyed by your opponent's Actional effects
	...
	--Add to the hand 1 Actional card from the RP
...
function s.thcon(e,tp,eg,ep,ev,re,r,rp,chk)
	return eg:IsExists(s.afilter,1,nil,tp) and Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_REST,0,1,nil)
end
function s.filter(c)
