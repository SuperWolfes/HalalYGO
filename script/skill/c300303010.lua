...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
	...
	--condition
	return aux.CanActivateSkill(tp) and Duel.GetMatchingGroupCount(Card.IsTrap,tp,LOCATION_REST,0,nil)==3
end
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SKILL_FLIP,tp,id|(1<<32))
	Duel.Hint(HINT_CARD,tp,id)
	--opd register
	local g=Duel.GetMatchingGroup(Card.IsTrap,tp,LOCATION_REST,0,nil)
