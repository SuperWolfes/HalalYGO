...
function s.chainfilter(re,ep,cid)
	return not (re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:IsActionalEffect())
end
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Cannot activate Actional Cards for the rest of the turn
	...
	e1:SetValue(function(e,re,tp) return re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:IsActionalEffect() end)
