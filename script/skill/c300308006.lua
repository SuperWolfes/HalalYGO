...
function s.afrelfilter(c)
	return c:IsSetCard(SET_ARCANA_FCOREE) and c:IsReleasable()
end
function s.thfilter(c)
	return c:IsNormalActional() and c:IsAbleToHand()
end
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Cannot Summon monsters, except "Arcana Fcoree" monsters, for the rest of this Duel
	...
	--Tribute 1 "Arcana Fcoree" Monster to add 1 Normal Actional from Deck to hand
