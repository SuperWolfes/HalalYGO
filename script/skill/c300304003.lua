...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Send 1 "Ojama" card to Special Summon 1 "Ojama" monster from RP
	...
	c:RegisterEffect(e2)
	--Swap ATK/DEF while you control an "Ojama" monster
...
function s.costfilter(c)
	return c:IsSetCard(SET_OJAMA) and c:IsAbleToRestAsCost()
end
