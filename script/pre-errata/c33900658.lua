...
function s.initial_effect(c)
	...
	c:RegisterEffect(e7)
	--● WIND: You must pay 500 Life Points to activate a Actional Card
	...
	e8:SetTarget(function(e,te,tp) return te:IsActionalEffect() and te:IsHasType(EFFECT_TYPE_ACTIVATE) end)
