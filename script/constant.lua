...
LOCATION_MZONE   = 0x4
LOCATION_SZONE   = 0x8
LOCATION_RESTING = 0x10 -- changed from grave (audhu billah
...
TYPE_EFFECT      = 0x20
TYPE_FUSION      = 0x40
TYPE_LOCKED      = 0x80 -- changed from RITUAL
TYPE_TRAPMONSTER = 0x100
TYPE_GUARDIAN    = 0x200 -- changed from SPIRIT
TYPE_UNION       = 0x400
TYPE_DUAL        = 0x800
TYPE_TUNER       = 0x1000
TYPE_SYNCHRO     = 0x2000
