...
LOCATION_MZONE   = 0x4
LOCATION_SZONE   = 0x8
LOCATION_RESTING = 0x10 -- changed from rest (audhu billah
LOCATION_REMOVED = 0x20
LOCATION_EXTRA   = 0x40
LOCATION_OVERLAY = 0x80
LOCATION_ONFIELD = 0x0c
LOCATION_PUBLIC  = 0x3c --LOCATION_ONFIELD+LOCATION_RESTING+LOCATION_REMOVED
LOCATION_ALL     = 0x3ff
...
TYPE_EFFECT      = 0x20
TYPE_FUSION      = 0x40
TYPE_LOCKED      = 0x80 -- changed from LOCKED
TYPE_TRAPMONSTER = 0x100
TYPE_GUARDIAN    = 0x200 -- changed from GUARDIAN
TYPE_UNION       = 0x400
TYPE_GUARDIAN        = 0x800
TYPE_TUNER       = 0x1000
TYPE_SYNCHRO     = 0x2000
...
RACE_MENTORALKNIGHT= 0x4000000 --
RACE_HIGHDRAGON   = 0x8000000
RACE_OMEGAMENTAL = 0x10000000
RACE_CELESTIALWARRIOR = 0x20000000
RACE_GALAXY       = 0x40000000
RACES_BEAST_BWARRIOR_WINGB = RACE_BEAST+RACE_BEASTWARRIOR+RACE_WINGEDBEAST --------------continue CONTINUE
--Reasons 
REASON_DESTROY     = 0x1
REASON_RELEASE     = 0x2
...
SUMMON_TYPE_GUARDIAN     = 0x12000000
...
RESETS_STANDARD           = RESET_TOFIELD|RESET_LEAVE|RESET_TODECK|RESET_TOHAND|RESET_TEMP_REMOVE|RESET_REMOVE|RESET_TORESTING|RESET_TURN_SET
...
RESETS_STANDARD_EXC_RESTING = RESETS_STANDARD&~(RESET_LEAVE|RESET_TORESTING)
--Effect types
EFFECT_TYPE_SINGLE     = 0x1
EFFECT_TYPE_FIELD      = 0x2
EFFECT_TYPE_EQUIP      = 0x4
EFFECT_TYPE_ACTIONALS  = 0x8
...
EFFECT_FLAG2_MAJESTIC_MUST_COPY = 0x80000000 -- kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk
--Effect codes
...
EFFECT_GUARDIAN_STATUS                = 75
EFFECT_EQUIP_LIMIT                  = 76
EFFECT_GUARDIAN_SUMMONABLE            = 77
...
EFFECT_MUST_BE_ATTACKED             = 195 -- THIS WAS A COMMENT
...
EFFECT_TO_RESTING_REDIRECT_CB         = 313
...
--EVENT_RETURN_TO_RESTING      = 1203 --deprecated
EVENT_TURN_END             = 1210
EVENT_PHASE                = 0x1000
...
CATEGORY_LEAVE_RESTING    = 0x4000000
...
GLOBALFLAG_SELF_TORESTING        = 0x100
...
WIN_REASON_MISSTRICK_MISCHIEF  = 0x1b
