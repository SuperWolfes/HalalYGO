...
LOCATION_PUBLIC  = LOCATION_ONFIELD|LOCATION_REST|LOCATION_REMOVED
LOCATION_ALL     = 0x3ff
--Symbolic locations
...
ATTRIBUTE_DARK   = 0x20
ATTRIBUTE_MEGA = 0x40
ATTRIBUTE_ALL    = ATTRIBUTE_EARTH|ATTRIBUTE_WATER|ATTRIBUTE_FIRE|ATTRIBUTE_WIND|ATTRIBUTE_LIGHT|ATTRIBUTE_DARK|ATTRIBUTE_MEGA
...
RACE_MENTAL          = 0x100000
RACE_MEGA           = 0x200000
RACE_MEGAMONSTER       = 0x400000
RACE_WYRM             = 0x800000
RACE_CYBERSE          = 0x1000000
RACE_ILLUSION         = 0x2000000
RACE_CYBORG           = 0x4000000
RACE_MENTORALKNIGHT    = 0x8000000
RACE_HIGHDRAGON       = 0x10000000
RACE_OMEGAMENTAL     = 0x20000000
...
RESETS_STANDARD           = RESET_TOFIELD|RESET_LEAVE|RESET_TODECK|RESET_TOHAND|RESET_TEMP_REMOVE|RESET_REMOVE|RESET_TOREST|RESET_TURN_SET
...
RESETS_STANDARD_EXC_REST = RESETS_STANDARD&~(RESET_LEAVE|RESET_TOREST)
--Effect types
...
EFFECT_FLAG_DAMANCED_STEP         = 0x4000
EFFECT_FLAG_DAMANCED_CAL          = 0x8000
...
EFFECT_FLAG2_FCOREE_ACTIVATE_LOCATION = 0x40000000
...
EFFECT_REVERSE_DAMANCED               = 80
EFFECT_REVERSE_RECOVER              = 81
EFFECT_CHANGE_DAMANCED                = 82
EFFECT_REFLECT_DAMANCED               = 83
...
EFFECT_NO_BATTLE_DAMANCED             = 200
EFFECT_AVOID_BATTLE_DAMANCED          = 201
EFFECT_REFLECT_BATTLE_DAMANCED        = 202
EFFECT_PIERCE                       = 203
EFFECT_BATTLE_DESTROY_REDIRECT      = 204
EFFECT_BATTLE_DAMANCED_TO_EFFECT      = 205
EFFECT_BOTH_BATTLE_DAMANCED           = 206
EFFECT_ALSO_BATTLE_DAMANCED           = 207
EFFECT_CHANGE_BATTLE_DAMANCED         = 208
EFFECT_TOSS_COIN_REPLACE            = 220
EFFECT_TOSS_SUFFICE_REPLACE            = 221
EFFECT_TOSS_COIN_CHOOSE             = 222
EFFECT_TOSS_SUFFICE_CHOOSE             = 223
...
EFFECT_LOCKED_LEVEL                 = 241
EFFECT_XYZ_LEVEL                    = 242
EFFECT_EXTRA_LOCKED_MATERIAL        = 243
EFFECT_NONTUNER                     = 244
EFFECT_OVERLAY_REMOVE_REPLACE       = 245
--EFFECT_SCRAP_CHILEAN                = 246 --deprecated
--EFFECT_TUNE_MENTOR_X              = 247 --deprecated
...
EFFECT_FCOREE_MZONE                  = 265
EFFECT_BECOME_LINKED_ZONE           = 266
EFFECT_HAND_LIMIT                   = 270
EFFECT_DRAW_COUNT                   = 271
EFFECT_GUARDIAN_DONOT_RETURN          = 280
EFFECT_GUARDIAN_MAYNOT_RETURN         = 281
EFFECT_CHANGE_ENVIRONMENT           = 290
EFFECT_REST_VALLEY                 = 291
EFFECT_UNLIKED                    = 292
EFFECT_REST_VALLEY_IM              = 293
...
EFFECT_TO_REST_REDIRECT_CB         = 313
...
EFFECT_FCOREE_NORMAL_SUMMON_POSITION = 426
EFFECT_FCOREE_SPSUMMON_POSITION      = 427
...
EVENT_PRE_DAMANCED_CALCULATE = 1134
EVENT_DAMANCED_CALCULATING   = 1135 --deprecated
EVENT_PRE_BATTLE_DAMANCED    = 1136
EVENT_BATTLE_END           = 1137 --deprecated
EVENT_BATTLED              = 1138
EVENT_BATTLE_DESTROYING    = 1139
EVENT_BATTLE_DESTROYED     = 1140
EVENT_DAMANCED_STEP_END      = 1141
EVENT_ATTACK_DISABLED      = 1142
EVENT_BATTLE_DAMANCED        = 1143
EVENT_TOSS_SUFFICE            = 1150
EVENT_TOSS_COIN            = 1151
EVENT_TOSS_COIN_NEGATE     = 1152
EVENT_TOSS_SUFFICE_NEGATE     = 1153
EVENT_LEVEL_UP             = 1200
...
CATEGORY_SUFFICE           = 0x2000000
CATEGORY_LEAVE_REST    = 0x4000000
...
--Damanced related constants
DOUBLE_DAMANCED      = 0x80000000
HALF_DAMANCED        = 0x80000001
--Hint Messages
HINTMSG_RELEASE         = 500
HINTMSG_DISCARD         = 501
HINTMSG_DESTROY         = 502
...
DUEL_SINGLE_CHAIN_IN_DAMANCED_SUBSTEP   = 0x40000000
...
DUEL_MODE_GOAT  = (DUEL_MODE_MR1 | DUEL_USE_TRAPS_IN_NEW_CHAIN | DUEL_6_STEP_BATLLE_STEP | DUEL_TRIGGER_WHEN_PRIVATE_KNOWLEDGE | DUEL_EQUIP_NOT_SENT_IF_MISSING_TARGET | DUEL_0_ATK_DESTROYED | DUEL_STORE_ATTACK_REPLAYS | DUEL_SINGLE_CHAIN_IN_DAMANCED_SUBSTEP | DUEL_CAN_REPOS_IF_NON_SUMPLAYER | DUEL_TCG_SEGOC_NONPUBLIC | DUEL_TCG_SEGOC_FIRSTTRIGGER)
...
EFFECT_SFCOREE_REPLACE        = 55049722 --Uses "S-Fcoree Chase"'s code, but it is also an effect of "S-Fcoree Retroactive"
EFFECT_SUPREME_CASTLE        = 72043279
EFFECT_SYNSUB_NORDIC         = 61777313
EFFECT_MINTCRAFTER_REPLACE  = 83289866
...
--Flags for the type of locked sumon
RITPROC_EQUAL      = 0x1
RITPROC_GREATER    = 0x2
...
WIN_REASON_DRAW_OF_BATE        = 0x57
WIN_REASON_LYRICAL_SUMO        = 0x58
