...
function(filter,_type,lv,extrafil,extraop,matfilter,stage2,location,fcoreedselection,customoperation,specificmatfilter,requirementfunc,sumpos)
	...
	return	function(e,tp,eg,ep,ev,re,r,rp)
				...
				local tg=Duel.SelectMatchingCard(tp,aux.RestValleyFilter(Locked.Filter),tp,location,0,1,1,nil,filter,_type,e,tp,mg,mg2,func,specificmatfilter,lv,requirementfunc,sumpos)
				if #tg>0 then
