...
function s.spcon(e,c)
	...
	local rg1=Duel.GetMatchingGroup(s.spfilter,tp,LOCATION_MZONE+LOCATION_REST,0,nil,ATTRIBUTE_LIGHT,RACE_WARRIOR)
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local g=nil
	local rg=Duel.GetMatchingGroup(s.spfilter1,tp,LOCATION_MZONE+LOCATION_REST,0,nil,ATTRIBUTE_LIGHT+ATTRIBUTE_DARK,RACE_WARRIOR+RACE_TAINTED)
...
function s.sgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(Card.IsAbleToRemove,tp,0,LOCATION_HAND+LOCATION_ONFIELD+LOCATION_REST,e:GetHandler())
