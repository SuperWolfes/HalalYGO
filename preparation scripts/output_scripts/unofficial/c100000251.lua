...
function s.cfilter(c,e,tp,ft)
	...
	return Duel.IsExistingMatchingCard(s.rmfilter,tp,LOCATION_MZONE+LOCATION_REST,0,1,c,e,tp,ft+ct)
end
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g2=Duel.SelectMatchingCard(tp,s.rmfilter,tp,LOCATION_MZONE+LOCATION_REST,0,1,1,tc,e,tp,ct+ft)
