...
function s.condition(e,tp,eg,ep,ev,re,r,rp,chk)
	return eg:IsExists(aux.FaceupFilter(Card.IsRace,RACE_MEGA),1,nil,tp)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsRace,RACE_MEGA))
...
function s.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Damanced(1-tp,g:GetSum(Card.GetAttack),REASON_EFFECT)
end
