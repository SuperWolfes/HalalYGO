...
function s.hdcon(e,tp,eg,ep,ev,re,r,rp)
	...
	if (phase~=PHASE_DAMAGE and phase~=PHASE_DAMAGE_CAL) or Duel.IsDamancedCalculated() then return false end
...
function s.rdop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.ChangeBattleDamanced(1-tp,Duel.GetBattleDamanced(1-tp)/2)
end
