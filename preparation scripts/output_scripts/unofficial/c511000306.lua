...
function s.initial_effect(c)
	...
	--EARTH: Fcoree mismatching during End Phase if monster was not destroyed by this effect
	local e3b=e3a:Clone()
	...
	c:RegisterEffect(e5)
	--WIND: You cannot activate Actional Cards
	...
	e6a:SetValue(function(e,te,tp) return te:GetHandler():IsActional() and te:IsHasType(EFFECT_TYPE_ACTIVATE) end)
