...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.GetMatchingGroup(aux.RestValleyFilter(s.spfilter),tp,0x33,0,nil,e,tp,80019195)
	local g2=Duel.GetMatchingGroup(aux.RestValleyFilter(s.spfilter),tp,0x33,0,nil,e,tp,85800949)
	local g3=Duel.GetMatchingGroup(aux.RestValleyFilter(s.spfilter),tp,0x33,0,nil,e,tp,84565800)
