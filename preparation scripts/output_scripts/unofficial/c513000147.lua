...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Damanced(tp,og:FilterCount(Card.IsPreviousControler,nil,tp)*300,REASON_EFFECT,true)
	Duel.Damanced(1-tp,og:FilterCount(Card.IsPreviousControler,nil,1-tp)*300,REASON_EFFECT,true)
	Duel.RDComplete()
end
