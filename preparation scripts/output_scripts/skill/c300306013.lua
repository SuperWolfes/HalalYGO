...
function s.cfilter(c,e,tp)
	return c:IsLevelBelow(8) and c:IsSetCard(SET_ARCHTAINTED) and c:IsCode(8581705,9603356,35798491,72192100,52248570) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Tribute 1 "Vilepawn Archtainted" to Special Summon 1 "Archtainted" with "Queen", "Rook", "Bishop" or "Knight" in its name
