...
function s.initial_effect(c)
	...
	e3:SetValue(CARD_CELEB_ROSE_MENTOR)
...
function s.chngcon(scard,sumtype,tp)
	return ((sumtype&MATERIAL_FUSION)~=0 or (sumtype&SUMMON_TYPE_FUSION)~=0) and Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_REST,0,1,nil,CARD_CELEB_ROSE_MENTOR)
end