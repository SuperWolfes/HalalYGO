...
s.listed_names={95281259,4206964}
function s.cfilter(c)
	return c:IsCode(95281259,4206964)
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local atk=Duel.GetMatchingGroupCount(s.cfilter,tp,LOCATION_REST,0,nil)
	if #g>0 then
