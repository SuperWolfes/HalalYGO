...
function s.initial_effect(c)
	--Special summon 1 level 3 or lower tainted normal monster from RP
...
function s.filter(c,e,tp)
	return c:IsType(TYPE_NORMAL) and c:IsRace(RACE_TAINTED) and c:IsLevel(3) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
