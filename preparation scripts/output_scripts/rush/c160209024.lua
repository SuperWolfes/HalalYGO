...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return a and a:IsControler(1-tp) and 
		((tc and tc:IsFaceup() and tc:IsAttack(0) and tc:IsControler(tp)) or (Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_REST,0,1,nil,CARD_STRAYNGE_CAT,160209016)))
end
