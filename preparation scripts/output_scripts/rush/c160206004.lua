...
function s.valcheck(e,c)
	...
	local tc=g:GetFirst()
	local atk=0
	if #g==1 and (tc:HasFlagEffect(FLAG_DOUBLE_TRIB) or tc:HasFlagEffect(FLAG_DOUBLE_TRIB_DARK+FLAG_DOUBLE_TRIB_TAINTED+FLAG_DOUBLE_TRIB_0_ATK+FLAG_DOUBLE_TRIB_0_DEF+FLAG_DOUBLE_TRIB_EFFECT)) then
