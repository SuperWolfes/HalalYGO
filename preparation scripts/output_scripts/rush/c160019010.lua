--ロードスターの魔剣士
--Mentoral Swordsman of Roadstar
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return not c:IsCode(160204021) end
end
function s.spfilter(c,e,tp)
	return c:IsCode(160016024) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
