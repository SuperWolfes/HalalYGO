--燃将セヤネン
--Seyanen the Combustion Commander
...
function s.thfilter(c)
	return c:IsMonster() and c:IsRace(RACE_WARRIOR) and c:IsAttribute(ATTRIBUTE_FIRE|ATTRIBUTE_DARK) and c:IsLevel(8) and c:IsAbleToHand()
end
