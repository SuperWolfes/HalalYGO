-- アマゾネスの秘術
-- Amazonian Secret Technique
-- Scripted by Hatter
local s,id=GetID()
function s.initial_effect(c)
	-- Fusion Summon 1 "Amazonian" monster
...
function s.fexop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(function(e,c) return c:IsSetCard(0x4) and c:IsAbleToRest() end)
...
function s.extrafil_repl_filter(c)
	return c:IsMonster() and c:IsAbleToRest() and c:IsSetCard(0x4)
end
