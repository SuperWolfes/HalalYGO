...
function s.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_TOREST,nil,1,PLAYER_ALL,LOCATION_REMOVED)
end
...
function s.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(s.rmfilter,tp,LOCATION_REST+LOCATION_MZONE,0,e:GetHandler())
