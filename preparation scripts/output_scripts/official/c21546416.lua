...
function s.initial_effect(c)
	--This card's name becomes "Armed Dragon LV5" while on the field or in the RP
...
function s.spcostfilter(c,e,tp,armd_lv5)
	return c:IsMonster() and c:IsAbleToRestAsCost() and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_HAND|LOCATION_DECK,0,1,c,e,tp,armd_lv5)
end
