...
function s.initial_effect(c)
	--Destroy all cards on the field, except the targeted "Vendread" locked monster
...
function s.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x106) and c:IsSummonType(SUMMON_TYPE_LOCKED)
end
