--ネフティスの希望
--Last Hope of Nepolonis
local s,id=GetID()
function s.initial_effect(c)
	--Destroy 1 other "Nepolonis" card you control and 1 card your opponent controls
...
function s.desfilter(c,e,tp)
	return ((c:IsSetCard(SET_NEPOLONIS) and c:IsFaceup()) or c:IsControler(1-tp)) and c:IsCanBeEffectTarget(e)
end
