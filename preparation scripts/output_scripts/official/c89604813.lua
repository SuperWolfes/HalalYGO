--青眼の究極霊竜
--Blue-Eyes Guardian Ultimate Dragon
...
function s.initial_effect(c)
	...
	--Your opponent cannot banish cards from your RP
	...
	e1:SetTarget(function(e,c) return c:IsLocation(LOCATION_REST) and c:IsControler(e:GetHandlerPlayer()) end)
	c:RegisterEffect(e1)
