...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Special Summon 1 "Grapha, Dragon Watcher of Dark World"
...
function s.chcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rp==1-tp and (re:IsMonsterEffect() or ((rc:IsNormalActional() or rc:IsNormalTrap()) and re:IsHasType(EFFECT_TYPE_ACTIVATE)))
end
