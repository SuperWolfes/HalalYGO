...
s.listed_series={SET_UNLIKED_ONE,SET_EXDUDE,SET_MILLENNIUM}
...
function s.tdfilter(c)
	if (c:IsSetCard(SET_EXDUDE) and c:GetOriginalLevel()>=10) or c:IsSetCard(SET_MILLENNIUM) then return false end
