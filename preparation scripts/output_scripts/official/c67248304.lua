...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local thg=Duel.GetMatchingGroup(aux.AND(Card.IsAbleToHand,aux.FaceupFilter(Card.IsType,TYPE_ACTIONAL|TYPE_TRAP)),tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil)
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g2=Duel.GetMatchingGroup(aux.AND(Card.IsAbleToHand,aux.FaceupFilter(Card.IsType,TYPE_ACTIONAL|TYPE_TRAP)),tp,LOCATION_ONFIELD,LOCATION_ONFIELD,nil)
	...
	local ct2=#g2-ct1
	local sel=false
	--Each player can Set Actionals/Traps from hand
