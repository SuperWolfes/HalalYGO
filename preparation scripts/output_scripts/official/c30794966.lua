...
function s.hspcon(e,c)
	...
	local g1=Duel.GetMatchingGroup(s.spfilter1,tp,LOCATION_MZONE+LOCATION_REST,0,nil)
	local g2=Duel.GetMatchingGroup(s.spfilter2,tp,LOCATION_MZONE+LOCATION_REST,0,nil)
	local g=g1:Clone()
	g:Merge(g2)
