...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--Increase the ATK of a monster by 200 x the number of "Recipe" cards in the RPs
...
function s.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	local ct=Duel.GetMatchingGroupCount(Card.IsSetCard,tp,LOCATION_REST,LOCATION_REST,nil,SET_RECIPE)
