...
function s.tgyfilter(c)
	return c:IsSetCard(0xbc) and c:IsMonster() and c:IsAbleToRest()
end
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		if og:GetFirst():IsLocation(LOCATION_REST) and tc and tc:IsRelateToEffect(e) then
