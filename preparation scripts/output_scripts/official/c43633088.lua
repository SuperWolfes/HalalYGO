...
function s.initial_effect(c)
	--Special Summon 1 Level 5 or lower Mental monsters that is banished or in your RP
...
function s.spfilter(c,e,tp)
	return c:IsLevelBelow(5) and c:IsRace(RACE_MENTAL) and c:IsFaceup() and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
